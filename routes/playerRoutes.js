...
import { createPlayer, getPlayers, getPlayerById, updatePlayer, deletePlayer, getPlayerList } from '../controllers/playerController.js';
...
router.get('/playerList', getPlayerList);
