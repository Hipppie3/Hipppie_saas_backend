...
import {getTeams, getTeamById, updateTeam, deleteTeam, getTeamPublic, createTeam, getTeamsByLeague} from '../controllers/teamController.js'
...
router.get('/teamsByLeague', getTeamsByLeague); 
